...
<body>
    <header>
        ...
        <div class="texte">
            Welcome sailor !<br>
            Le but du jeu est d'atteindre le coffre dans chaque niveau.
    ...
    <main>
        <div class="obstacle">
            <img src="../sprites/32x32/ship.png" alt="Le bateau">
            <p>Le bateau : C'est lui que tu diriges à l'aide des tridents, sa direction initiale est le nord.</p>
        </div>
        
        <div class="obstacle">
            <img src="../sprites/32x32/trident2_n.png"" alt="Les tridents">
            <img src="../sprites/32x32/trident2_e.png"" alt="Les tridents">
            <img src="../sprites/32x32/trident2_s.png"" alt="Les tridents">
            <img src="../sprites/32x32/trident2_w.png"" alt="Les tridents">
        ...
        <div class="obstacle">
            <img src="../sprites/32x32/krabby.png"" alt="Krabby">
        ...
        <div class="obstacle">
            <img src="../sprites/32x32/pieuvre.png"" alt="Pieuvre crocheteuse">
            <p>Pieuvre crocheteuse : Description de la pieuvre crocheteuse.</p>
        </div>
        <div class="obstacle">
            <img src="../sprites/32x32/la_main.png"" alt="La main de l'eau">
            <p>La main de l'eau : Description de la main de l'eau.</p>
        </div>
        <div class="obstacle">
            <img src="../sprites/32x32/guardian1.png"" alt="Guardian">
            <p>Guardian : Description du Guardian.</p>
        </div>
        <div class="obstacle">
            <img src="../sprites/32x32/vague.png"" alt="Vague">
            <p>Vague : Description de la vague.</p>
        </div>
        <div class="obstacle">
            <img src="../sprites/32x32/rock1.png"" alt="Rocher">
            <p>Rocher : si tu passes dessus t'exploses en gros.</p>
        </div>
        <div class="obstacle">
            <img src="../sprites/32x32/rock.png"" alt="Rocher1">
            <p>Rocher : si tu passes dessus t'exploses en gros.</p>
        </div>
    </main>
</body>
