...
<body>
    ...
    <div id="inventory">
        <div class="arrow" data-direction="up"><img src="../pixel_art_projet/32x32/up-arrow.png" alt="Up" /><span class="arrow-count" data-direction="up">3</span></div>
        <div class="arrow" data-direction="down"><img src="../pixel_art_projet/32x32/down-arrow.png" alt="Down" /><span class="arrow-count" data-direction="down">2</span></div>
